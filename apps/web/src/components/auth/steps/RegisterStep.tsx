...
const BUSINESS_TYPE_OPTIONS = [
  { value: "OBRT_PAUSAL", label: "Pausalni obrt" },
  ...
  return (
    ...
    >
      <div className="text-center">
        <h1 className="text-2xl font-bold text-white">Kreirajte racun</h1>
        <motion.button
          type="button"
          onClick={onBack}
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="mt-2 text-xs text-white/50">
            Pomoci ce nam da personaliziramo vasu pocetnu konfiguraciju
          </p>
        </div>
