...
export default function ClientInvitation({ invitationUrl, staffName, message }: ClientInvitationProps) {
  return (
    <Html lang="hr">
      <Head />
        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.footer}>
            <Text style={styles.footerLink}>
              Imate pitanja? <Link href="https://fiskai.hr/contact" style={styles.link}>Kontaktirajte nas</Link>
            </Text>
