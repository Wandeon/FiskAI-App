...
export function ToolUpsellCard({
  ...
  if (variant === "inline") {
    return (
      <div className="my-4 flex items-center justify-between gap-4 rounded-lg border border-blue-200 bg-blue-50 p-4">
        ...
        <Link
          href={ctaLink}
          className="flex-shrink-0 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700"
        >
          {ctaText}
        </Link>
      </div>
  ...
  // Default - full card
  return (
    <div className="my-8 overflow-hidden rounded-xl border border-blue-200 bg-gradient-to-br from-blue-600 to-indigo-700 shadow-lg">
      <div className="p-6 text-white">
        ...
        <Link
          href={ctaLink}
          className="inline-flex items-center gap-2 rounded-lg bg-white px-6 py-3 font-semibold text-blue-700 shadow-md transition-transform hover:scale-105 hover:shadow-lg"
        >
          {ctaText}
