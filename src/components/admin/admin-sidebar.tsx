...
export function AdminSidebar({ defaultCollapsed = false }: AdminSidebarProps) {
  ...
  return (
    <aside
      ...
      className={cn(
        "flex flex-col bg-surface-2 text-foreground transition-all duration-300",
        isCollapsed ? "w-16" : "w-64"
      )}
    >
      {/* Header */}
      <div className="p-4 border-b border-default" role="banner">
        {!isCollapsed && (
          <>
            <h1 className="text-xl font-bold">FiskAI Admin</h1>
            <p className="text-xs text-secondary">Platform Management</p>
          </>
        )}
        {isCollapsed && (
      ...
      <div className="border-t border-default p-4 space-y-2" role="contentinfo">
        ...
        <Link
          ...
          aria-label="Settings"
          className={cn(
            "flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-secondary hover:bg-surface hover:text-foreground transition-colors",
            "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-border-focus focus-visible:ring-offset-2",
            isCollapsed && "justify-center"
          )}
        >
        ...
        <Button
          ...
          className={cn(
            "w-full text-secondary hover:text-foreground hover:bg-surface",
            "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-border-focus focus-visible:ring-offset-2",
            isCollapsed && "px-0"
          )}
        >
