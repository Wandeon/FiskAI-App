...
export function BulkOperations() {
 ...
 <CardDescription>
 Export data for {selectedClients.size} selected client{selectedClients.size !== 1 ? "s" : ""}
 </CardDescription>
 </CardHeader>
 <CardContent>
 ...
 <CardDescription>
 Generate aggregate reports across all assigned clients
 </CardDescription>
 </CardHeader>
 <CardContent>
 <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
 ...
 <div className="text-2xl font-bold">
 {reportData.totals.pendingReview}
 </div>
 </div>
 </div>
 )}
 ...
 <div className="text-right">
 <div className={`font-medium ${client.netProfit >= 0 ? "text-success-icon" : "text-danger-icon"}`}>
