...
function getSeverityIcon(daysLeft: number, severity: string | null) {
 ...
 if (daysLeft <= 3 || severity === "critical") return <AlertTriangle className="h-5 w-5 text-danger-icon" />
 if (daysLeft <= 7 || severity === "high") return <AlertTriangle className="h-5 w-5 text-warning-icon" />
