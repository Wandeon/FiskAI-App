        ...
        <Container style={container}>
          ...
          <Section style={statusBox}>
            ...
            <Text style={statusChange}>
              <span
                style={{ ...statusBadge, backgroundColor: statusColors[oldStatus] || "#6b7280" }}
              >
                {statusLabels[oldStatus] || oldStatus}
              </span>
              <span style={arrow}> → </span>
              <span
                style={{ ...statusBadge, backgroundColor: statusColors[newStatus] || "#6b7280" }}
              >
          ...
          <Section style={detailsBox}>
            ...
            <Text style={detailLabel}>
              <strong>Promijenio:</strong> {changedByName || changedByEmail}
            </Text>
            <Text style={detailLabel}>
