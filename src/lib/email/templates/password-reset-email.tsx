    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>Primili smo zahtjev za resetiranje lozinke vašeg FiskAI računa.</Text>

          <Text style={text}>Za postavljanje nove lozinke, kliknite na gumb ispod:</Text>
