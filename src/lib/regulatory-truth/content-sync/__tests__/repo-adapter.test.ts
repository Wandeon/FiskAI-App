...
describe("generatePRBody", () => {
  ...
  it("includes all patched files", () => {
    const params = createMockPRBodyParams({
      patchedFiles: [
        "content/vodici/pdv-prag.mdx",
        "content/vodici/pdv-registracija.mdx",
      ],
    })
    const body = generatePRBody(params)
  ...
  it("includes RTL Content Sync header", () => {
    ...
    expect(body).toContain(
      "automatically generated by the Regulatory Truth Layer"
    )
  })
  ...
  it("handles different change types", () => {
    const createBody = generatePRBody(
      createMockPRBodyParams({ changeType: "create" })
    )
    const updateBody = generatePRBody(
      createMockPRBodyParams({ changeType: "update" })
    )
    const repealBody = generatePRBody(
      createMockPRBodyParams({ changeType: "repeal" })
    )
