  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        <p className="text-sm font-medium text-blue-600">Staff Portal</p>
          ...
          {tabs.map((tab) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  "flex items-start gap-3 rounded-lg border border-slate-200 p-3 transition-all",
                  isActive
            ...
            <Card>
              ...
              <CardContent>
                <div className="rounded-lg bg-slate-50 p-6 text-center">
                  ...
                  <h3 className="mt-3 text-base font-medium text-slate-900">Coming Soon</h3>
