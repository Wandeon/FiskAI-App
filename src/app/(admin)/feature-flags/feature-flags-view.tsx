    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <div className="rounded-lg border border-amber-200 bg-amber-50 p-4">
          <div className="text-2xl font-bold text-amber-700">{stats.archived}</div>
          <div className="text-sm text-amber-600">Archived</div>
        </div>
      </div>
              ...
              <tr key={flag.id} className="hover:bg-slate-50">
                <td className="px-4 py-4">
                  <div className="flex items-start gap-3">
                    <Flag className="mt-0.5 h-5 w-5 text-slate-400" />
                    <div>
