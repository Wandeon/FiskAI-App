...
export function DigestPage({ digestData }: DigestPageProps) {
 ...
 <CardContent>
 <div className="text-2xl font-bold text-danger-icon">{digestData.actionItems.length}</div>
 </CardContent>
 </Card>
 </div>
 ...
 <div className="flex justify-between items-center">
 <span className="text-success-icon">New MRR this week</span>
 <span className="text-lg font-semibold text-success-icon">+€{digestData.mrr.newMRR}</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-danger-icon">Churned MRR this week</span>
 <span className="text-lg font-semibold text-danger-icon">
 ...
 <div className="flex items-center gap-3">
 <Mail className="h-8 w-8 text-info-icon" />
 <div>
 ...
 <div className="text-center">
 <p className="text-2xl font-bold text-info-icon">
 ...
 {alert.autoAction && (
 <p className="text-sm text-info-icon mt-1">→ {alert.autoAction}</p>
 )}
 </div>
 ))}
 </CardContent>
