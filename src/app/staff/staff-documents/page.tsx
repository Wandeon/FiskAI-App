...
import { Search, FolderOpen, FileText, Receipt, File } from "lucide-react"
...
export default async function StaffDocumentsPage({ searchParams }: PageProps) {
  ...
  function buildFilterLink(params: {
    category?: string
    client?: string
    search?: string
    page?: number
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-5">
        <Link
          ...
          className={cn("block transition-colors", !category && "ring-2 ring-primary")}
        >
        ...
        <Link
          ...
          className={cn("block transition-colors", category === "invoice" && "ring-2 ring-primary")}
        >
          <Card className="hover:bg-accent/50">
            <CardContent className="pt-6">
        ...
        <Link
          ...
          className={cn("block transition-colors", category === "expense" && "ring-2 ring-primary")}
        >
          <Card className="hover:bg-accent/50">
            <CardContent className="pt-6">
            ...
            <div className="flex items-center gap-2">
              ...
              {category && (
                <Badge variant="secondary">
                  ...
                  <Link
                    href={buildFilterLink({ client: clientIdParam, search: searchTerm })}
                    className="ml-2"
                  >
                    ×
                  </Link>
              ...
              {clientIdParam && (
                <Badge variant="secondary">
                  ...
                  <Link
                    href={buildFilterLink({ category: categoryParam, search: searchTerm })}
                    className="ml-2"
                  >
                    ×
                  </Link>
              ...
              {searchTerm && (
                <Badge variant="secondary">
                  Search: &quot;{searchTerm}&quot;
                  <Link
                    href={buildFilterLink({ category: categoryParam, client: clientIdParam })}
                    className="ml-2"
                  >
                    ×
                  </Link>
              ...
              <Link href="/staff-documents" className="text-sm text-primary hover:underline">
                Clear all
              </Link>
            </div>
          )}
        ...
        <CardContent className="p-0">
          {documents.length === 0 ? (
            <div className="py-12">
              <EmptyState
                icon={
                  searchTerm ? <Search className="h-8 w-8" /> : <FolderOpen className="h-8 w-8" />
                }
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        {React.createElement(CATEGORY_META[doc.category].icon, {
                          className: "h-4 w-4",
                        })}
                        <span
                          className={cn(
