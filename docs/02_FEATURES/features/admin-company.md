...
2. `src/app/admin/[companyId]/page.tsx:17-380` - Company detail page with stats, users, and audit logs
...
5. `src/app/api/admin/auth/route.ts:1-31` - Authentication API for login/logout with cookie management
6. `src/app/api/admin/companies/[companyId]/audit/route.ts:1-49` - CSV export endpoint for audit logs
7. `src/lib/admin.ts:1-21` - Admin utilities: isGlobalAdmin, MODULE_LABELS, getEntitlementsList
