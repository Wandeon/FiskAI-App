...
| ------ | --------------- | -------------------------------------------------------------------- |
| `[I]`  | **Implemented** | Production-ready. Routes exist, functionality works, tests pass.     |
| `[P]`  | **Partial**     | Core happy path works. Missing edge cases, polish, or full scope.    |
...
| F016              | View Invoices                 | Invoicing     | [I]    | /invoices                          | High       | [→](features/invoicing-view.md)            |
...
| F020              | Invoice Filtering             | Invoicing     | [I]    | /invoices                          | Medium     | [→](features/invoicing-filtering.md)       |
...
| F030              | View Expenses                 | Expenses      | [I]    | /expenses                          | High       | [→](features/expenses-view.md)             |
...
| F034              | Expense Filtering             | Expenses      | [I]    | /expenses                          | Medium     | [→](features/expenses-filtering.md)        |
...
| F045              | Banking Documents             | Banking       | [I]    | /banking/documents                 | Medium     | [→](features/banking-documents.md)         |
| **CONTACTS**      |
...
**Status Audit:** 2025-12-28

### Status Distribution

| Status          | Count | Percentage |
| --------------- | ----- | ---------- |
| [I] Implemented | 107   | 99.1%      |
| [P] Partial     | 0     | 0%         |
| [S] Scaffold    | 1     | 0.9%       |
| [D] Designed    | 0     | 0%         |

### Scaffold Features Requiring Implementation

| ID   | Feature            | Issue                          | Resolution                  |
| ---- | ------------------ | ------------------------------ | --------------------------- |
| F036 | Recurring Expenses | Model exists but no UI/actions | Implement CRUD + scheduling |
