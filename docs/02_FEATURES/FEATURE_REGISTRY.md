...
| **DASHBOARD**     |
| F007              | Main Dashboard                | Dashboard     | ❌     | /dashboard                         | High       | -                                    |
| F008              | Quick Stats Display           | Dashboard     | ❌     | /dashboard                         | Medium     | -                                    |
| F009              | Revenue Trends                | Dashboard     | ❌     | /dashboard                         | Medium     | -                                    |
| F010              | Invoice Funnel                | Dashboard     | ❌     | /dashboard                         | Medium     | -                                    |
| F011              | Recent Activity Feed          | Dashboard     | ❌     | /dashboard                         | Medium     | -                                    |
| F012              | Action Cards                  | Dashboard     | ❌     | /dashboard                         | Low        | -                                    |
| F013              | VAT Overview                  | Dashboard     | ❌     | /dashboard                         | Medium     | -                                    |
| F014              | Onboarding Checklist          | Dashboard     | ❌     | /onboarding                        | Medium     | -                                    |
| **INVOICING**     |
