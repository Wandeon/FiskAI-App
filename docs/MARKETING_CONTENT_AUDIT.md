...
Generated: 2025-12-21T10:38:58.403Z
Target: https://fiskai.hr
Repos: /home/admin/FiskAI/.worktrees/marketing-content-governance-plan, /home/admin/FiskAI-next
...
- /register (marketing-content-governance-plan)
- /reset-password (marketing-content-governance-plan)
- /select-role (marketing-content-governance-plan)
- /verify-email (marketing-content-governance-plan)
- /wizard (marketing-content-governance-plan)
...
- Links:
  ...
  - /alati/${tool.slug} (internal, dynamic)
...
- Data dependencies: fiscal-data, knowledge-hub/constants
- Links:
  - /baza-znanja (internal, ok)
  - /alati (internal, ok)
  - /register (internal, auth)
...
- Links:
  ...
  - /usporedba/pocinjem-solo (internal, ok)
  - /alati (internal, ok)
  - /usporedba/${comparison.slug} (internal, dynamic)
  - /vodic/${guide.slug} (internal, dynamic)
- Buttons:
  - None
- Hardcoded values:
  - None
...
- Links:
  - /baza-znanja (internal, ok)
  - /kako-da/${howto.slug} (internal, dynamic)
- Buttons:
  - None
- Hardcoded values:
  - None
...
- Links:
  ...
  - /alati/kalkulator-poreza (internal, ok)
  - /alati/uplatnice (internal, ok)
- Buttons:
  - None
- Hardcoded values:
...
- Links:
  - /baza-znanja (internal, ok)
  - #${letter} (internal, dynamic)
  - /rjecnik/${term.slug} (internal, dynamic)
- Buttons:
  - None
- Hardcoded values:
  - None
...
- Links:
  - /vodic/obrt-dohodak (internal, ok)
  - /vodic/doo (internal, ok)
  - /kako-da/uci-u-sustav-pdv (internal, ok)
  - /for/accountants (internal, ok)
- Buttons:
  - None
- Hardcoded values:
  - None
...
- Links:
  ...
  - /alati (internal, ok)
  - /vijesti (internal, ok)
  - /vijesti/kategorija/${category.slug} (internal, dynamic)
  - /register (internal, auth)
  - /vijesti/${post.slug} (internal, dynamic)
  - /alati/kalendar (internal, ok)
- Buttons:
  - None
- Hardcoded values:
